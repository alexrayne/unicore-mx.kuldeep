...
/** @cond */
#if defined(UNICOREMX_USART_H)
/** @endcond */
#ifndef UNICOREMX_USART_COMMON_F124_H
#define UNICOREMX_USART_COMMON_F124_H

#include <unicore-mx/stm32/common/usart_common_all.h>
